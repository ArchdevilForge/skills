...
打分前读 [`../x-viral/references/emotion-hooks.md`](../x-viral/references/emotion-hooks.md)：这条让观众想纠正你 / 看结果 / 看翻车 / 辨真伪 / 支招 / 带入自己 / 证明自己？踩不中任何一点就降权或不入选。

| 标准 | 权重 |
|------|------|
| 新鲜度：48-72h 内首发 | 最高 |
| 硬数字/首创：「首个开源」「提升 50%」「价格减半」「家用显卡可跑」「被收购」 | 高 |
| 流量七点：至少踩中一点（见 emotion-hooks.md） | 高 |
| 实操价值：用户今天/下周就能试（小红书收藏信号，七点不管这个） | 中 |
...
1. [热点名称] — 热度/新鲜度
   核心卖点: ...
   踩中七点: 纠正你 / 看结果 / 看翻车 / 辨真伪 / 支招 / 带入自己 / 证明自己（标主打 1 点）
   小红书角度: 标题钩子建议 + 为什么能爆
